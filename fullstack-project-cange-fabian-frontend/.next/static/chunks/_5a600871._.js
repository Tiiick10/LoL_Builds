            ...
            if (token) {
                ...
                try {
                    ...
                    fetch(`http://127.0.0.1:8000/api/users/${userId}/`, {
                        ...
                        "HeroSection.useEffect": (res)=>res.json()
                    }["HeroSection.useEffect"]).then({
                        "HeroSection.useEffect": (data)=>{
...
_s(HeroSection, "9vWwm0ZSlZ6Pr/7sHpbTAUi03kk=", false, function() {
    return [
...
//# sourceMappingURL=_5a600871._.js.map