...
function BuildDetailPage() {
    ...
    const handleVote = async (type)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/builds/${id}/${type}/`);
            setBuild((prev)=>({
                    ...prev,
...
_s(BuildDetailPage, "a5+XC1mjJEwGUE/dNEdwJJ7ZTMI=", false, function() {
    return [
